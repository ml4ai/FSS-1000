...
# Modified: added additional command line arguments
# parser.add_argument('--input-data', default='/xdisk/claytonm/projects/arete-realsim/fss-1000/data/')
# parser.add_argument('--output-results', action='store_true', default='/xdisk/claytonm/projects/arete-realsim/fss-1000/results/')
...
parser.add_argument("-td","--test_dir",type=str,default='imgs/example/query')      # defualt modified
